...
public class SwaggerConfig {
	...
	private ApiInfo swaggerInfo() {
		...
		return new ApiInfoBuilder().title("MEMBER API").description("회원 관리 기능 CRUD 문서").build();
	}
	...
	public Docket swaggerApi() {
		return new Docket(DocumentationType.SWAGGER_2)
	               ...
	               .build()                                       //최종적으로 Docket(문서객체) 생성
	               .useDefaultResponseMessages(false);                  //Swagger 제공 기본 응답메시지(401,403) 설정 비활성화 => 개발자가 명시적으로 응답 형식 지정
